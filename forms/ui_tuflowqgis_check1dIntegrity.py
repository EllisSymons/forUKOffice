...
#
# Created: Sun May 27 17:55:46 2018
...
class Ui_check1dIntegrity(object):
    def setupUi(self, check1dIntegrity):
        ...
        self.correctPipeDir_inverts_cb.setEnabled(False)
        self.correctPipeDir_inverts_cb.setGeometry(QtCore.QRect(8, 26, 16, 21))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.correctPipeDir_dirContinuity_cb = QtGui.QCheckBox(self.groupBox_6)
        self.correctPipeDir_dirContinuity_cb.setEnabled(False)
        self.correctPipeDir_dirContinuity_cb.setGeometry(QtCore.QRect(8, 68, 16, 21))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.correctPipeDir_dirContinuity_cb.setFont(font)
        self.correctPipeDir_dirContinuity_cb.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.correctPipeDir_dirContinuity_cb.setText(_fromUtf8(""))
        self.correctPipeDir_dirContinuity_cb.setObjectName(_fromUtf8("correctPipeDir_dirContinuity_cb"))
        self.label_5 = QtGui.QLabel(self.groupBox_6)
        self.label_5.setGeometry(QtCore.QRect(27, 60, 221, 51))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_6.setGeometry(QtCore.QRect(28, 23, 211, 31))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, check1dIntegrity):
        ...
        self.label_5.setText(_translate("check1dIntegrity", "Based on pipe direction continuity - will check upstream and downstream pipe directions for continuity", None))
        self.label_6.setText(_translate("check1dIntegrity", "Based on inverts - will correct if pipe gradient is adverse", None))
