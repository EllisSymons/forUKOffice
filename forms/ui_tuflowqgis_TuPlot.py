...
class Ui_tuflowqgis_TuPlot(object):
    def setupUi(self, tuflowqgis_TuPlot):
        ...
        self.HydPropList = QListWidget(self.tab_1)
        self.HydPropList.setMinimumSize(QtCore.QSize(200, 50))
        self.HydPropList.setMaximumSize(QtCore.QSize(200, 75))
        self.HydPropList.setSelectionMode(QAbstractItemView.ExtendedSelection)
        self.HydPropList.setObjectName(_fromUtf8("HydPropList"))
        self.verticalLayout.addWidget(self.HydPropList)
        ...
        self.AddHydTab = QPushButton(self.Control)
        ...
        self.CloseHydTab = QPushButton(self.Control)
