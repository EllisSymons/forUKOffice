...
version = '2018-10-AD Beta'  # added output figures
now = datetime.now()
...
access_web = False  # once the .html files have been read, they are saved and you can set this to false for debugging
...
arg_map = {'name': 0, 'coords': 1, 'area': 2, 'mag': 3, 'dur': 4, 'nonstnd': 5, 'format': 6, 'output_notation': 7,
           ...
           'lossvalue': 16, 'tuflow_loss_method': 17, 'addtp': 18, 'point_tp': 19, 'areal_tp': 20, 'arffreq': 21,
           'minarf': 22, 'out': 23, 'offline_mode': 24, 'arr_file': 25, 'bom_file': 26, 'catchment_no': 27}
